...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers(HttpMethod.POST, apiAdmin()).hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.DELETE, apiAdmin()).hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT, apiAdmin()).hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.PATCH, apiAdmin()).hasAnyAuthority("ADMIN")
