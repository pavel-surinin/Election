var DistrictEditFormComponent = React.createClass({
	  render: function() {
		    return (
		                ...
		                <form onSubmit={this.props.onHandleUpdate} role="form">
		                  <fieldset>
		                  	<div className="input-group">
		                  		<label>Naujas apylinkės pavadinimas</label>
					                <input
				                      type="text"
				                      onChange={this.props.onHandleChangeName}
				                      value={this.props.name}
				                      className="form-control"
				                      placeholder="Naujas apylinkės pavadinimas"
				                      name="name"
				                      required
				                    />
					              </div><br/>
		...
		window.DistrictEditFormComponent = DistrictEditFormComponent;
