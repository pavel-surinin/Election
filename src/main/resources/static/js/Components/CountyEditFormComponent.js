var CountyEditFormComponent = React.createClass({
	  render: function() {
		    return (
		                ...
		                <form onSubmit={this.props.onHandleUpdate} role="form">
		                  <fieldset>
		                  	<div className="input-group">
		                  		<label>Naujas apygardos pavadinimas</label>
					                <input
				                      type="text"
				                      onChange={this.props.onHandleChangeName}
				                      value={this.props.name}
				                      className="form-control"
				                      placeholder="Naujas apygardos pavadinimas"
				                      name="name"
				                      required
				                    />
					              </div><br/>
		...
		window.CountyEditFormComponent = CountyEditFormComponent;
