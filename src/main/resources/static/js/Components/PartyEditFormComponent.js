var PartyEditFormComponent = React.createClass({
	  render: function() {
		    return (
		                ...
		                <form onSubmit={this.props.onHandleUpdate} role="form">
		                  <fieldset>
		                  	<div className="input-group">
		                  		<label>Naujas partijos pavadinimas</label>
					                <input
				                      type="text"
				                      onChange={this.props.onHandleChangeName}
				                      value={this.props.name}
				                      className="form-control"
				                      placeholder="Naujas partijos pavadinimas"
				                      name="name"
				                      required
				                    />
					              </div><br/>
		...
		window.PartyEditFormComponent = PartyEditFormComponent;
