var DistrictResultsMultiTableRow = React.createClass({
  ...
  render: function() {
    ...
    if (p.rating.length != 0) {
      return(
      <div>
        <a data-toggle="tooltip" data-placement="left" title='Reitingai' ref='modal' type="button" className="btn btn-info btn-outline btn-sm" data-toggle="modal" data-target={'#ratingModal' + p.id}>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <table className="table table-hover">
                  ...
                  <tbody>
                    {p.rating.map(function(rating,index){
                      return(
                          <tr key={index}>
                            <td>
...
window.DistrictResultsMultiTableRow = DistrictResultsMultiTableRow;
