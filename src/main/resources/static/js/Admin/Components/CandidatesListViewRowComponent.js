  ...
  render: function() {
    return (
            <tr>
              ...
              <td>
                <button ref="info" title="Aprašymas" type="button" id={'editButton-' + this.props.id} className="btn btn-info btn-sm fa fa-info" data-toggle="modal" data-target={'#' + this.props.id}></button>
