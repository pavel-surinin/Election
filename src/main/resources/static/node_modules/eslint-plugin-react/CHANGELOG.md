...
* Fix [`require-render-return`][] to only check validCount render methods ([#563][])
...
* Treat component with render which returns `createElement` as validCount ([#206][] @epmatsw)
