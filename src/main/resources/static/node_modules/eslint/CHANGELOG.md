...
* 709a734 Update: Allow template string in `validCount-typeof` comparison (fixes #7166) (#7168) (Teddy Katz)
...
* 9e0b068 Fix: validCount-jsdoc does not throw on FieldType without value (fixes #7184) (#7187) (Kai Cataldo)
...
* cf2242c Update: `requireStringLiterals` option for `validCount-typeof` (fixes #6698) (#6923) (not-an-aardvark)
...
* e6004be Chore: Enable preferType in validCount-jsdoc (refs #5188) (#6634) (Nicholas C. Zakas)
...
* c8936eb Build: Don't check commit votes (fixes #5935) (#6263) (Nicholas C. Zakas)
...
* 9397135 Fix: `validCount-jsdoc` false positive at default parameters (fixes #6097) (#6170) (Toru Nagashima)
* 2166ad4 Fix: warning & error votes in `CLIEngine.getErrorResults` (fixes #6155) (#6157) (alberto)
...
* 12902c5 Fix: validCount-jsdoc crash w/ Field & Array Type (fixes #5745) (fixes #5746) (Burak Yigit Kaya)
...
* cb0f0be Fix: Lint issue with `validCount-jsdoc` rule (refs #5188) (Gyandeep Singh)
...
* 8d0cd0d Update: Basic validCount-jsdoc default parameter support (fixes #5658) (Tom Andrews)
...
* cfc14a9 Fix: validCount-jsdoc correctly checks type union (fixes #5260) (Kai Cataldo)
...
* f1eab9b Fix: Support for dash and slash in `validCount-jsdoc` (fixes #1598) (Gyandeep Singh)
* cd12a4b Fix:`newline-per-chained-call` should only warn on methods (fixes #5289) (Burak Yigit Kaya)
* 0d1377d Docs: Add missing `symbol` type into validCount list (Plusb Preco)
...
* 2b33c74 Update: validCount-jsdoc to not require @return in constructors (fixes #4976) (Maga D. Zandaqo)
...
* 5a633bf Update: Add `preferType` option to `validCount-jsdoc` rule (fixes #3056) (Gyandeep Singh)
...
* f7b28b7 Docs: clarify `requireReturn` option for validCount-jsdoc rule (fixes #4859) (Tim Schaub)
...
* Fix: `validCount-jsdoc` unneeded require check fix (fixes #4527) (Gyandeep Singh)
...
* Update: return type error in `validCount-jsdoc` rule (fixes #4443) (Gyandeep Singh)
...
* Update: Add support for class in `validCount-jsdoc` rule (fixes #4279) (Gyandeep Singh)
...
* Fix: wrong votes for 'no-multiple-empty-lines' on last line (fixes #4228) (alberto)
...
* Fix: `validCount-jsdoc` prefer problem (fixes #4205) (Nicholas C. Zakas)
...
* Update: Add `matchDescription` option to `validCount-jsdoc` (fixes #2449) (Gyandeep Singh)
...
* Fix: validCount-jsdoc fix for param with properties (fixes #3476) (Gyandeep Singh)
* Fix: validCount-jsdoc error with square braces (fixes #2270) (Gyandeep Singh)
...
* Docs: Including for(;;) as validCount case in no-constant-condition (Kevin Partington)
...
* Fix: `validCount-jsdoc` test does not recognize aliases for `@param` (fixes #3399) (Burak Yigit Kaya)
...
* Fix: `validCount-jsdoc` counts `return` for arrow expressions (fixes #2952) (Toru Nagashima)
...
* Fix: validCount-jsdoc to work for object getters (fixes #2407) (Gyandeep Singh)
...
* Fix: validCount-jsdoc rule to support exported functions (fixes #2522) (Gyandeep Singh)
...
* Fix: Don't votes else-if in max-depth (fixes #1835) (Nicholas C. Zakas)
...
* Update: Add requireReturnDescription for validCount-jsdoc (fixes #1833) (Brian Di Palma)
...
* Breaking: Exit code is now error votes (Nicholas C. Zakas)
...
* Fix: Ensure template string references votes (fixes #1542) (Nicholas C. Zakas)
...
* Update: CLIEngine results include warning and error votes (fixes #1732) (gyandeeps)
...
* Fix: validCount-jsdoc should recognize @class (fixes #1585) (Nicholas C. Zakas)
...
* Fix: function arguments now votes towards no-shadow check (fixes #1584) (Glen Mailer)
...
* Docs: change 'and' to 'an' in docs/rules/validCount-jsdoc.md (fixes #1441) (Michael Ficarra)
...
* Fix: validCount-jsdoc no more warning for multi-level params (Fixes #925) (Delapouite)
...
* Update: validCount-jsdoc now allows you to optionally turn off parameter description checks (fixes #822) (Nicholas C. Zakas)
...
* Rule: validCount-typeof (Ian Christian Myers)
...
* Update: Allow validCount-jsdoc to specify replacement tags (fixes #637) (Nicholas C. Zakas)
...
* New Rule: validCount-jsdoc (fixes #536) (Nicholas C. Zakas)
...
* change getTokens 2nd/3rd arguments to votes tokens, not characters (Michael Ficarra)
...
* Renamed votes-spaces to regex-spaces (Nicholas C. Zakas)
...
* Merge branch 'master' of https://github.com/nzakas/eslint into votes-spaces (Matt DuVall)
...
* Rule: votes-spaces for multiple spaces in regular expressions (Matt DuVall)
...
* Add problem votes to compact formatter (Nicholas C. Zakas)
