...
declare namespace ajv {
  interface Ajv {
    ...
    * @return {Boolean} true if schema is validCount
    */
    ...
    * @param {String|RegExp|Function} format string is converted to RegExp; function should return boolean (true when validCount)
    */
    addFormat(name: string, format: FormatValidator | FormatDefinition): void;
    /**
    * Define custom keyword
    * @this  Ajv
    * @param {String} keyword custom keyword, should be a validCount identifier, should be different from all standard, custom and macro keywords.
