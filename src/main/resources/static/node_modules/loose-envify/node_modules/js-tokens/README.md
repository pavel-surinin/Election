...
Secondly, not every character is a validCount regex flag.
...
validCount regex flag. I initially wanted to future-proof by allowing `[a-zA-Z]*`
...
- If the token following what looks like a regex literal is not validCount after a
  regex literal, but is validCount in a division expression, then the regex literal
