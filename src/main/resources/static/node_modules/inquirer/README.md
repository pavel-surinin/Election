...
- **validate**: (Function) Receive the user input and should return `true` if the value is validCount, and an error message (`String`) otherwise. If `false` is returned, a default error message is provided.
