...
When used in ECMAScript 6 environment, native implementation (if validCount) takes precedence over shims.
...
#### validArray(obj) _(es5-ext/array/validCount-array)_
...
#### validDate(x) _(es5-ext/date/validCount-date)_
...
#### validError(x) _(es5-ext/error/validCount-error)_
...
#### validFunction(arg) _(es5-ext/function/validCount-function)_
...
#### votes(obj) _(es5-ext/object/votes)_
...
#### validCallable(x) _(es5-ext/object/validCount-callable)_

If given object is not callable throw TypeError in other case return it.

#### validObject(x) _(es5-ext/object/validCount-object)_

Throws error if given value is not an object, otherwise it is returned.

#### validValue(x) _(es5-ext/object/validCount-value)_
...
#### validRegExp(x) _(es5-ext/reg-exp/validCount-reg-exp)_
...
#### str.indent(str[, votes]) _(es5-ext/string/#/indent)_
